...
import "./styles/_workInProgressStyles.scss";
...
const WorkInProgress = () => {
  useEffect(() => {
    ...
    if (volumeCTRL) {
      volumeCTRL.addEventListener("input", toggleAudio);
    }
    ...
    const RESET = () => {
      gsap.set(".vvg__eyebrows", { display: "none" });
      gsap.set(
        [".vvg__eyes", ".vvg__ear", ".vvg__eyes-group", ".vvg__code-block"],
        {
          transformOrigin: "50% 50%",
        }
      );
      gsap.set(".vvg__head-group", { transformOrigin: "50% 60%" });
      gsap.set(".vvg__bulb-dashes", {
        transformOrigin: "50% 50%",
        scale: 0,
        opacity: 1,
      });
      gsap.set(".vvg__bulb", { display: "none" });
      gsap.set(".vvg__code-block", { scale: 0 });
      gsap.set(".vvg__code-block", {
        "--block-color": () => `var(--owl-${Math.floor(random(1, 6))})`,
        rotation: () => random(-45, 45),
      });
    };

    const LAPTOP_ROCK = gsap
      .timeline({
        paused: true,
      })
      .to(".vvg__laptop", {
    ...
    const THINK = () => {
      ...
      THINK_TL = gsap.timeline().to(".vvg__head-group", {
        delay,
        repeatDelay,
        onComplete: () => THINK(),
        rotate: () => random(-10, 10),
    ...
    const FIRE_BLOCKS = gsap.timeline({
      paused: true,
    });
    ...
    const DOWN = () =>
      gsap
        .timeline({
          ...
          onStart: () => {
            gsap.set([".vvg__eyebrows", ".vvg__bulb"], { display: "none" });
          },
        })
        .to(".vvg__head-group", { duration: TIMING.DOWN, yPercent: 10 }, 0)
        .to(
          ".vvg__eyes",
          { duration: TIMING.DOWN, scaleY: 0.9, yPercent: 75 },
          0
        )
        ...
        .to(
          ".vvg__ear",
          { duration: TIMING.DOWN, yPercent: -40, scaleY: 0.85 },
          0
        );
      ...
      gsap
        .timeline({
          ...
          onStart: () => {
            ...
            gsap.to(".vvg__eyes-group", { xPercent: 0 });
            THINK();
          },
        })
        ...
        .to(
          [".vvg__eyes", ".vvg__cheeks"],
          { duration: TIMING.UP, yPercent: 0 },
          0
        )
  ...
  return (
    <div>
      <svg className="vvg" viewBox="0 0 104.211 178.897">
        <defs>
          <clipPath id="b">
            <path
        ...
        <g className="vvg__code-block vvg__code-block--left">
          <path
            ...
            style={{
              fontFamily: "JetBrains Mono, Ultra-Bold",
