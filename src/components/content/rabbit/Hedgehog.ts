...
export class Hedgehog implements IHedgehog {
  ...
  init(): void {
    ...
    this.body = new THREE.Mesh(bodyGeom, this.material.blackMat);

    let headGeom = new THREE.BoxGeometry(5, 5, 7, 1);
    this.head = new THREE.Mesh(headGeom, this.material.lightBrownMat);
    this.head.position.z = 6;
    this.head.position.y = -0.5;

    let noseGeom = new THREE.BoxGeometry(1.5, 1.5, 1.5, 1);
    this.nose = new THREE.Mesh(noseGeom, this.material.blackMat);
    ...
    let irisGeom = new THREE.BoxGeometry(0.5, 1, 1);
    ...
    for (var i = 0; i < 9; i++) {
      ...
      let sr = new THREE.Mesh(spikeGeom, this.material.blackMat);
      sr.position.x = 3;
      ...
      let sl = new THREE.Mesh(spikeGeom, this.material.blackMat);
      sl.position.x = -3;
    ...
    let earGeom = new THREE.BoxGeometry(2, 2, 0.5, 1);
    this.earL = new THREE.Mesh(earGeom, this.material.lightBrownMat);
    ...
    let mouthGeom = new THREE.BoxGeometry(1, 1, 0.5, 1);
